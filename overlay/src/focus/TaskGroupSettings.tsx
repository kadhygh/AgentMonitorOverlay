...
export function TaskGroupSettings({ groups, revision, reviewGroupId, open, onClose, onChanged }: { groups: TaskGroup[]; revision: number; reviewGroupId: string | null; open: boolean; onClose: () => void; onChanged: () => void }) {
